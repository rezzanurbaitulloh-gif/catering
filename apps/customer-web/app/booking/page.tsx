...
export default async function BookingPage({ searchParams }: { searchParams: { paket?: string; tanggal?: string; tipe?: string; pax?: string } }) {
  ...
  return (
    <div className="container-x max-w-3xl py-10">
      ...
      <div className="card mt-6">
        <BookingForm tipeList={tipeList} paketAwal={paket} initialTanggal={searchParams.tanggal ?? ""} initialTipe={searchParams.tipe ?? ""} initialPax={searchParams.pax ?? ""} />
      </div>
    </div>
  );
}
